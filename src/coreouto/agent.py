...
_DEFAULT_SYSTEM_PROMPT = (
    ...
    "Use <finish> exactly once, at the very end of your response, around the complete final answer. "
    "Don't put <finish> mid-response or as a literal example — the agent loop extracts the FIRST match, "
    "so any extra occurrences can hijack the return value.\n\n"
    "Example:\n"
